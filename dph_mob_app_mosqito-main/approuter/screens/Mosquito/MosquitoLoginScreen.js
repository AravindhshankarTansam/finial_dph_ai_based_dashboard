...
export default function MosquitoLoginScreen({ navigation }) {
 ...
 const handleLogin = async () => {
  if (!userId || !password) {
    Alert.alert('Validation Error', 'Please enter Email ID and password');
    return;
  }
  ...
  try {
    ...
    if (user.module !== 'mosquito') {
      Alert.alert('Access Denied', 'You are not authorized to access this module');
      setLoading(false);
      return;
    }
        ...
        <ScrollView contentContainerStyle={styles.container} keyboardShouldPersistTaps="handled">
          ...
          <View style={styles.logoContainer}>
            <Image
              ...
              resizeMode="contain"
            />
            <Text style={styles.logoText}>Domestic Breeding Checker</Text>
