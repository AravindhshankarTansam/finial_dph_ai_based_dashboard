    ...
    <DashboardLayout>
      ...
      <Box p={2}>
        <Box display="flex" justifyContent="space-between" alignItems="center" mb={2}>
          ...
          >
            {userHubName
              ? `${userHubName.toUpperCase()} – GOVERNMENT HOMES MASTER DATA`
        ...
        <Dialog open={openDialog} onClose={() => setOpenDialog(false)} maxWidth="sm" fullWidth>
          <DialogTitle sx={{ fontFamily: "Nunito, sans-serif" }}>Add Government Home</DialogTitle>
...
/>
        ...
        >
          <Alert
            ...
            sx={{ width: "100%" }}
          >
            Government Home added successfully!
          </Alert>
        </Snackbar>
      </Box>
      </div>
