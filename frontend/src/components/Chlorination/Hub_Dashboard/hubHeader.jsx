    ...
    fetch("http://localhost:3000/dashboard/chl-hubusers")
      ...
      .then((data) => {
        ...
        if (currentUser) {
          ...
          setUser(currentUser); // ✅ set user so Box is shown
        }
      });
  }, []);
    ...
    >
      ...
      >
        ...
        <div className="flex-grow-1 text-center header-color header-title-wrap">
          ...
          <h4 className="gov-title">Regional Water Analysis Laboratory - {hubName
              ? `${hubName}  Dashboard`
              : "Water Analysis Hub Dashboard"}</h4>
