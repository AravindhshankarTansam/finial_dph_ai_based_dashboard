...
export default function GovernmentHospitalsMasterTable() {
...
const columns = [
  ...
  { field: "name", headerName: "Hospital Name", width: 300 },
    ...
    <DashboardLayout>
      ...
      <Box p={2}>
        <Box display="flex" justifyContent="space-between" alignItems="center" mb={2}>
          ...
          >
            {userHubName
              ? `${userHubName.toUpperCase()} – GOVERNMENT HOSPITAL MASTER DATA`
              : "GOVERNMENT HOSPITAL MASTER DATA"}
          </Typography>
