...
const ChlorinationHeader = ({ toggleSidebar }) => {
    ...
    <nav className="navbar navbar-light bg-light px-3 shadow-sm header-nav">
      ...
      >
        ...
        <div className="flex-grow-1 text-center header-color header-title-wrap">
          ...
          <h4 className="mb-0 dph-title2">
            Regional Water Analysis Laboratory -Admin Dashboard
          </h4>
          
        </div>

        {/* Right side: HUD + Avatar */}
...
export default ChlorinationHeader;
