...
const DistUserContributionTable = () => {
  ...
  return (
    <div className="mt-4">
      ...
      {/* Filters */}
      {/* Filters + Download Button in same row */}
      ...
      >
       ...
       <tbody>
            {filteredData.map((user, idx) => {
                ...
                backgroundColor: isTargetMet ? "#d4edda" : "#f8d7da", // Green or red background
                fontWeight: 600,
                textAlign: "center",
                };
...
export default DistUserContributionTable;
